...
class UserController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/{transitionName}", name="user_flow")
     */
    public function nextFlow(Registry $workflows, User $user, string $transitionName): Response
    {
        $workflow = $workflows->get($user, 'user_admin');
        if ($workflow->can($user, $transitionName)) {
